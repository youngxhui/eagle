  ...
  changeContent(): void {
    switch (this.current) {
      ...
      case 1: {
        ...
        this.courseEntity.tip.id = Number(this.values[0]);
        this.courseEntity.subTip.id = Number(this.values[1]);
        this.courseEntity.level.id = Number(this.level);
        // @ts-ignore
        if (this.level === '1') {
          this.levelname = '简单';
